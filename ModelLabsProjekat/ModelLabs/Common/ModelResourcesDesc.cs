...
{	
	...
	public class ModelResourcesDesc
	{
		...
		private void InitializeNotSettablePropertyIds()
		{
            ...
            //sta ne moze da se propusti kroz server (da dodje kroz deltu),liste referenci i gid
            notSettablePropertyIds.Add(ModelCode.IDOBJ_GID);
            notSettablePropertyIds.Add(ModelCode.REGULATINGCONTROL_REGULATINGCONDEQS);
           ...
           //notSettablePropertyIds.Add(ModelCode.TERMINAL_RCONTROLS);	 		        	
